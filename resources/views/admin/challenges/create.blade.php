...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ajouter un défi</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="reward" name="reward" value="{{ old('reward', 0) }}" required>
                            @error('reward')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="target" name="target" value="{{ old('target') }}" placeholder="Ex: 5 pour 5 parrainages">
                            @error('target')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="icon_name" name="icon_name" value="{{ old('icon_name') }}" placeholder="Ex: trophy, star, medal">
