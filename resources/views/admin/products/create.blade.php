        ...
        <div class="card-body">
            <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="promotion_price" name="promotion_price" value="{{ old('promotion_price') }}">
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="is_on_promotion" name="is_on_promotion" {{ old('is_on_promotion') ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="category" name="category" required>
                        ...
                        <option value="formation_pack" {{ old('category') == 'formation_pack' ? 'selected' : '' }}>Formation Pack</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="metadata" name="metadata" rows="3">{{ old('metadata') }}</textarea>
                    @error('metadata')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
